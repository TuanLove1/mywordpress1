...
class Cream_Magazine_News_Widget_One extends WP_Widget {
    ...
    function __construct() { 
        ...
        parent::__construct(
            ...
            esc_html__( 'CM Full: News Widget 1', 'cream-magazine' ),   // Name
            array(
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <select class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'post_cat' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'post_cat' ) ); ?>">
                <option value="<?php esc_attr_e( 'none', 'cream-magazine' ); ?>" <?php selected( $instance['post_cat'], 'none' ); ?>><?php esc_html_e( 'Select Category', 'cream-magazine' ); ?></option>
                <?php
                if( !empty( $categories ) ) {
