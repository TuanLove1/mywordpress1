...
if ( ! class_exists( 'Blossom_Feminine_Select_Control' ) ) {

	/**
	 * Select control.
	 */
	class Blossom_Feminine_Select_Control extends Wp_Customize_Control {

		public $type = 'blossom-feminine-select';
        ...
        public function enqueue() {
            ...
            wp_enqueue_script( 'blossom-feminine-select', get_template_directory_uri() . '/inc/custom-controls/select/select.js', array( 'jquery', 'selectize' ), false, true ); //for multi select    
        }
