...
if ( ! class_exists( 'Blossom_Feminine_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Blossom_Feminine_Slider_Control extends Wp_Customize_Control {

		public $type = 'blossom-feminine-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'blossom-feminine-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'blossom-feminine-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
