<?php
/**
 * Blossom Feminine Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Feminine_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Feminine_Repeater_Setting extends WP_Customize_Setting {
