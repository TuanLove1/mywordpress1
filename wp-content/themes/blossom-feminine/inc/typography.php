...
if( ! function_exists( 'blossom_feminine_fonts_url' ) ) :
/**
...
function blossom_feminine_fonts_url(){
    ...
    */
    $primary    = _x( 'on', 'Primary Font: on or off', 'blossom-feminine' );
    $secondary  = _x( 'on', 'Secondary Font: on or off', 'blossom-feminine' );
    $site_title = _x( 'on', 'Site Title Font: on or off', 'blossom-feminine' );
 ...
 * Get Google Fonts
*/
function blossom_feminine_get_google_fonts(){
...
*/
function blossom_feminine_get_websafe_font(){
...
*/
function blossom_feminine_check_varient( $font_family = 'serif', $font_variants = 'regular', $body = false ){
    $variant = '';
    $var     = array();
    $google_fonts  = blossom_feminine_get_google_fonts(); //Google Fonts
    $websafe_fonts = blossom_feminine_get_websafe_font(); //Standard Web Safe Fonts
...
*/
function blossom_feminine_get_css_variant( $font_variant ){
    $v_array = array(
		'100'       => array(
            'weight'    => '100',
            'style'     => 'normal'
...
*/
function blossom_feminine_is_google_font( $font ){
    $return = false;
    $websafe_fonts = blossom_feminine_get_websafe_font();
    if( $font ){
...
*/
function blossom_feminine_get_fonts( $font_family, $font_variant ){
    
    $fonts = array();
    $websafe_fonts = blossom_feminine_get_websafe_font(); //Web Safe Font
    
    if( $font_family ){
        if( blossom_feminine_is_google_font( $font_family ) ){
            $fonts['font'] = esc_attr( $font_family ); //Google Font
            if( $font_variant ){
                $weight_style    = blossom_feminine_get_css_variant( blossom_feminine_check_varient( $font_family, $font_variant ) );
