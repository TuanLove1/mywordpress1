...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) :
		...
		<h2 class="comments-title">
			<?php
			$cream_magazine_comment_count = get_comments_number();
			if ( '1' === $cream_magazine_comment_count ) {
				printf(
					/* translators: 1: title. */
		...
		if ( ! comments_open() ) :
			?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'cream-magazine' ); ?></p>
			<?php
		endif;
