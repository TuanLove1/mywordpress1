...
<div class="row-settings-block" data-parent="f_list" data-no-values="custom_meta_field_check custom_local_attribute_check">
...
<div class="row-settings-block wpfHidden" data-parent="f_list" data-no-values="custom_meta_field_check custom_local_attribute_check">
	<div class="settings-block-label settings-w100 col-xs-4 col-sm-3">
		...
		<div class="settings-value settings-w100">
			<?php 
				HtmlWpf::selectbox('f_sort_by', array(
					'options' => array('default' => esc_attr__('Don\'t sort', 'woo-product-filter'), 'asc' => 'ASC', 'desc' => 'DESC'),
					'attrs' => 'class="woobewoo-flat-input"'
				));
				?>
		</div>
...
<div class="row-settings-block wpfTypeSwitchable" data-type="list radio" data-parent="f_list" data-no-values="custom_meta_field_check custom_local_attribute_check">
	<div class="settings-block-label col-xs-4 col-sm-3">
